...
namespace Lextm.SharpSnmpLib.Mib
{
    ...
    {
		// mc++  private static readonly log4net.ILog Logger = log4net.LogManager.GetLogger("Lextm.SharpSnmpLib.Mib");
        ...
        private static IList<IModule> CompileToModules(string file, TextReader stream)
        {
			...
			// mc++ Logger.Info(watch.ElapsedMilliseconds.ToString(CultureInfo.InvariantCulture) + "-ms used to parse " + file);
            watch.Stop();
            return doc.Modules;
        }
    }
