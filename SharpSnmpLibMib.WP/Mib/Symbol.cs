	...
	public sealed class Symbol : IEquatable<Symbol>
	{
		...
		private static bool UseStricterValidation
		{
			get
			{
				...
				{
					// mc++ object setting = ConfigurationManager.AppSettings["StricterValidationEnabled"];
					// mc++ _useStricterValidation = setting != null && Convert.ToBoolean(setting.ToString(), CultureInfo.InvariantCulture);
				}
